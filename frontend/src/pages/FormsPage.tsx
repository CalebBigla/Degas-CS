            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="mt-4">
                  ...
                  {form.qr_code && (
                    <div className="flex items-center gap-3 mt-3 p-3 bg-gray-50 rounded border border-gray-200">
                      <img 
                        src={form.qr_code} 
                        alt="Form QR Code" 
                        className="w-20 h-20 border border-gray-300 rounded"
                        title="Scan to access registration form"
                      />
                      <div className="text-sm text-gray-600">
                        <p className="font-medium text-gray-900">QR Code Generated</p>
                        <p className="text-xs">Scan to access registration form</p>
                      </div>
                    </div>
                  )}
                </div>
